...
t_train = t_train'; t_test = t_test';
    ...
    kernel='RBF_kernel';
    C = 10;
    [gam,sig2]=HHO(SearchAgents_no,Max_iter,lb,ub,dim,type,p_train,t_train,p_test,t_test);
...
legend('real', 'hho-wlssvm predict')
xlabel('sample')
ylabel('result')
...
legend('hho-wlssvm error')
xlabel('sample')
ylabel('error')
string = {'Test set error'};
title(string)
grid
HHO=[T_test;T_sim2_filtered;test_Error_filtered];
save('HHO.mat', 'HHO')
...
HHOR2=[T_test;T_sim2;r_2_col];
save('HHOR2.mat', 'HHOR2')
end