...
t_train = t_train'; t_test = t_test';
    ...
    kernel='RBF_kernel';
    C = 10;
    [gam,sig2]=SSA(SearchAgents_no,Max_iter,lb,ub,dim,type,p_train,t_train,p_test,t_test);
...
legend('real', 'ssa-wlssvm predict')
xlabel('sample')
ylabel('result')
...
legend('ssa-wlssvm error')
xlabel('sample')
ylabel('error')
string = {'Test set error'};
title(string)
grid
SSA=[T_test;T_sim2_filtered;test_Error_filtered];
save('SSA.mat', 'SSA')
...
SSAR2=[T_test;T_sim2;r_2_col];
save('SSAR2.mat', 'SSAR2')
end