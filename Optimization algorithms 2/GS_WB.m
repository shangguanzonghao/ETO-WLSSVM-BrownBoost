...
while remaining_time > s && i < max_iter
    ...
    kernel='RBF_kernel';
    C = 10;
    [gam,sig2]=GS(SearchAgents_no,Max_iter,lb,ub,dim,type,p_train,t_train,p_test,t_test);
...
legend('real', 'GS-wlssvm-brownboost predict')
xlabel('sample')
ylabel('result')
...
legend('GS-wlssvm-brownboost error')
xlabel('sample')
ylabel('error')
