...
res2 = readtable('feature_SOH_SNL_18650_NCA_25C_0-100_0.5-1C_a_timeseries.csv');
res3 = readtable('feature_SOH_SNL_18650_NMC_25C_0-100_0.5-1C_a_timeseries.csv');
res4 = readtable('feature_SOH_wenzhou_#02.csv');
res5 = readtable('second_01_cycling_wExpansion.csv'); 
res6 = readtable('second_CY25-025_1-#1.csv');
res7 = readtable('second_CY25-05_1-#1.csv');
...
while remaining_time > s && i < max_iter
    ...
    kernel='RBF_kernel';
    C = 10;
    [gam,sig2]=TPE(SearchAgents_no,Max_iter,lb,ub,dim,type,p_train,t_train,p_test,t_test);
...
legend('real', 'TPE-wlssvm-brownboost predict')
xlabel('sample')
ylabel('result')
...
legend('TPE-wlssvm-brownboost error')
xlabel('sample')
ylabel('error')
